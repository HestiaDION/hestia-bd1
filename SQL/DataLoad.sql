...
dt_inicio, dt_expiracao, faculdade, ponto_ref, regras, id_anunciante, id_boost) VALUES 
	(12345678, 'Apartamento', 345, 'Rua das Palmeiras', 'Jardim das Flores', 'São Paulo', 'SP', 3, 5, 2500.00, 'I', '2024-10-01', '2025-04-01', 'Universidade Federal de São Paulo', 'Parque Ibirapuera', 'Proibido realizar festas, horário de silêcio a partir das 22h, visitas somente até às 23h', (select id from anunciante where username = 'julianev'), 1),
	(98765432, 'Casa', 120, 'Avenida Brasil', 'Centro', 'Rio de Janeiro', 'RJ', 4, 6, 3800.00, 'A', '2024-09-20', '2025-03-20', 'Universidade do Estado do Rio de Janeiro','Maracanã', 'Manter as áreas comuns limpas, não tocar instrumentos musicais após às 21h', (select id from anunciante where username = 'robcarvalho'), 2),
	('54321987', 'Kitnet', 15, 'Rua dos Lírios', 'Vila Nova', 'Belo Horizonte', 'MG', 1, 2, 1200.00, 'A', '2025-09-25', '2025-03-25', 'Universidade Federal de Minas Gerais', 'Praça da Liberdade', 'Limpeza das áreas comuns será feita de forma alternada (semanalmente), proibido o uso de aparelhos de som acima de 50 decibéis', (select id from anunciante where username = 'tavaragusto'), 3);
...
INSERT INTO telefone_anunciante (tel, id_anunciante) VALUES 
	(11912345678, 1),
	(21987654321, 2),
	(31246801357, 3);

INSERT INTO telefone_universitario (tel, id_universitario) VALUES 
	(119123456333, 1),
	(21987654699, 2),
	(31246801377, 3);

INSERT INTO foto (url, id_anuncio) VALUES 
	('https://example.com/apartamento.jpg', 1),
	('https://example.com/casa.jpg', 2),
	('https://example.com/kitnet.jpg', 3);

INSERT INTO universitario_filtro (id_filtros, id_universitario) VALUES 
	(1, 1),
	(3, 1),
	(1, 2),
	(2, 2),
...
INSERT INTO anuncio_filtro (id_filtros, id_anuncio) VALUES 
	(1, 1),
	(4, 1),
	(1, 2),
	(2, 2),
...
onde vivi durante minha graduação na Universidade Federal do Rio de Janeiro (UFRJ). Gostaria que o imóvel fosse alugado para
...
que usei durante minha formação na Universidade Federal de Minas Gerais (UFMG). Prefiro que o espaço seja ocupado por estudantes e,
...
INSERT INTO universitario (dne, nome, username, email, senha, genero, plano, foto_perfil, descricao, id_anuncio,
						   ...
						   'Estudante de arquitetura apaixonada por design sustentável e arquitetura minimalista. Gosto de viajar e explorar novos lugares.', 5, 3),
						   ...
						   'Carioca, estudante de engenharia civil na UFRJ. Amo praticar esportes, especialmente surf e futebol. Gosto de aproveitar o que o Rio tem de melhor.',
							7, 10),
